...
var MOON_CATALOG = {
  ...
  materials: [
    ...
    { id: 'white', name: 'White', hex: 'ffffff', image: 'blob-truth/materialfinish-white.jpg', collection: 'Solids', tier: 0, rocks: 0 },
    ...
    { id: 'agtSnowWhite', name: 'AGT Snow White', hex: 'eef0ef', image: 'blob-truth/materialfinish-agtsnowwhite.jpg', collection: 'Signia', tier: 1, rocks: 15 },
    { id: 'antiqueWhite', name: 'Antique White', hex: 'fffcf3', image: 'blob-truth/materialfinish-antiquewhite.jpg', collection: 'Solids', tier: 1, rocks: 15 },
    { id: 'pearl', name: 'Pearl', hex: 'e1e2dc', image: 'blob-truth/materialfinish-pearl.jpg', collection: 'Signia', tier: 1, rocks: 15 },
    { id: 'antiquePearl', name: 'Antique Pearl', hex: 'e1ddd1', image: 'blob-truth/materialfinish-antiquepearl.jpg', collection: 'Signia', tier: 1, rocks: 15 },
    { id: 'lightGrey', name: 'Light Grey', hex: 'cdcec8', image: 'blob-truth/materialfinish-lightgrey.jpg', collection: 'Solids', tier: 1, rocks: 15 },
    { id: 'darkGrey', name: 'Dark Grey', hex: 'a2a2a0', image: 'blob-truth/materialfinish-darkgrey.jpg', collection: 'Solids', tier: 1, rocks: 15 },
    { id: 'latitudeGrey', name: 'Latitude Grey', hex: '9e9788', image: 'blob-truth/materialfinish-latitudegrey.jpg', collection: 'Signia', tier: 1, rocks: 15 },
    { id: 'almond', name: 'Almond', hex: 'efe2bf', image: 'blob-truth/materialfinish-almond2.jpg', collection: 'Solids', tier: 1, rocks: 15 },
    { id: 'black', name: 'Black', hex: '000000', image: 'blob-truth/materialfinish-black.jpg', collection: 'Solids', tier: 1, rocks: 15 },
    { id: 'onyx', name: 'Onyx', hex: '282725', image: 'blob-truth/materialfinish-onyx.jpg', collection: 'Signia', tier: 1, rocks: 15 },
    { id: 'charcoalCharbon', name: 'Charcoal Charbon', hex: '3b3d3a', image: 'blob-truth/materialfinish-charcoalcharbon.jpg', tier: 1, rocks: 15 },
    { id: 'riverRock', name: 'River Rock', hex: 'b2aea5', image: 'blob-truth/materialfinish-riverrock.jpg', collection: 'Signia', tier: 1, rocks: 15 },
    { id: 'mocha', name: 'Mocha', hex: '69605a', image: 'blob-truth/materialfinish-mocha.jpg', collection: 'Signia', tier: 2, rocks: 30 },
    { id: 'fusionMaple', name: 'Fusion Maple', hex: 'cbab7e', image: 'blob-truth/materialfinish-fusionmaple.jpg', collection: 'Woodgrains', tier: 2, rocks: 30 },
    { id: 'hardRockMaple', name: 'Hard Rock Maple', hex: 'c9a97c', image: 'blob-truth/materialfinish-hardrockmaple.jpg', collection: 'Woodgrains', tier: 2, rocks: 30 },
    { id: 'honeyMaple', name: 'Honey Maple', hex: 'b07442', image: 'blob-truth/materialfinish-honeymaple.jpg', collection: 'Woodgrains', tier: 2, rocks: 30 },
    { id: 'candlelight', name: 'Candlelight', hex: 'b47e52', image: 'blob-truth/materialfinish-candlelight.jpg', collection: 'Woodgrains', tier: 2, rocks: 30 },
    { id: 'oysterPine', name: 'Oyster Pine', hex: '585753', image: 'blob-truth/materialfinish-oysterpine.jpg', collection: 'Signia', tier: 2, rocks: 30 },
    { id: 'sandPine', name: 'Sand Pine', hex: '9c8a74', image: 'blob-truth/materialfinish-sandpine.jpg', collection: 'Signia', tier: 2, rocks: 30 },
    { id: 'autumnLeaves', name: 'Autumn Leaves', hex: '502512', image: 'blob-truth/materialfinish-autumnleaves.jpg', collection: 'Signia', tier: 2, rocks: 30 },
    { id: 'springBlossom', name: 'Spring Blossom', hex: '413a34', image: 'blob-truth/materialfinish-springblossom.jpg', collection: 'Signia', tier: 2, rocks: 30 },
    { id: 'summerBreeze', name: 'Summer Breeze', hex: 'ccbda2', image: 'blob-truth/materialfinish-summerbreeze.jpg', collection: 'Signia', tier: 2, rocks: 30 },
    { id: 'cherryBlossom', name: 'Cherry Blossom', hex: '623d31', image: 'blob-truth/materialfinish-cherryblossom.jpg', collection: 'Woodgrains', tier: 2, rocks: 30 },
    ...
    { id: 'tafWinterCherry', name: 'TAF Winter Cherry', hex: 'a16535', image: 'blob-truth/materialfinish-tafwintercherry.jpg', collection: 'Signia', tier: 3, rocks: 35 },
    { id: 'espresso', name: 'Espresso', hex: '101212', image: 'blob-truth/materialfinish-espresso.jpg', collection: 'Signia', tier: 3, rocks: 35 },
    { id: 'sandstone', name: 'Sandstone', hex: 'd2cbc1', image: 'blob-truth/materialfinish-sandstone.jpg', collection: 'Signia', tier: 3, rocks: 35 },
    { id: 'greystone', name: 'Greystone', hex: 'c4c2bd', image: 'blob-truth/materialfinish-greystone.jpg', collection: 'Signia', tier: 3, rocks: 35 },
    { id: 'summerFlame', name: 'Summer Flame', hex: '874d35', image: 'blob-truth/materialfinish-summerflame.jpg', collection: 'Woodgrains', tier: 3, rocks: 35 },
    { id: 'pearwood', name: 'Pearwood', hex: 'b06b40', image: 'blob-truth/materialfinish-pearwood.jpg', collection: 'Woodgrains', tier: 3, rocks: 35 },
    { id: 'darkTeak', name: 'Dark Teak', hex: '726157', image: 'blob-truth/materialfinish-darkteak.jpg', collection: 'Signia', tier: 4, rocks: 55 },
    { id: 'lightTeak', name: 'Light Teak', hex: 'b89878', collection: 'Signia', tier: 4, rocks: 55 },
    { id: 'africanWalnut', name: 'African Walnut', hex: '463130', image: 'blob-truth/materialfinish-africanwalnut.jpg', collection: 'Woodgrains', tier: 4, rocks: 55 },
    { id: 'wildCherry', name: 'Wild Cherry', hex: '7d402f', image: 'blob-truth/materialfinish-wildcherry.jpg', collection: 'Woodgrains', tier: 5, rocks: 80 },
    { id: 'okanoganCherry', name: 'Okanogan Cherry', hex: '8e4d30', image: 'blob-truth/materialfinish-okanogancherry.jpg', collection: 'Woodgrains', tier: 5, rocks: 80 },
    { id: 'chocolatePear', name: 'Chocolate Pear', hex: '443734', image: 'blob-truth/materialfinish-chocolatepear.jpg', collection: 'Woodgrains', tier: 5, rocks: 85 },
