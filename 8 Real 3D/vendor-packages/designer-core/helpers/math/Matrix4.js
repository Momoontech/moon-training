...
class Matrix4 {
    ...
    makeRotationAxis(axis, angle) {
        // Based on http://www.gameenginebook.com/foundations-of-game-engine-development-volume-1-mathematics/
     ...
     */
    makePerspective(left, right, top, bottom, near, far, coordinateSystem = 0) {
        const te = this.elements;
     ...
     */
    makeOrthographic(left, right, top, bottom, near, far, coordinateSystem = 0) {
        const te = this.elements;
