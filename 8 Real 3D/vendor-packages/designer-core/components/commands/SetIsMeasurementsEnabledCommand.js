 ...
 */
class SetIsMeasurementsEnabledCommand extends FoldableSignalCommand {
    constructor(newValue) {
        super((core) => core.isMeasurementsEnabled, newValue);
    }
}

export { SetIsMeasurementsEnabledCommand as default };
